...
import com.rishi_pc.calculator.Activities.CalculatorActivity;
import com.rishi_pc.calculator.R;
...
public class ConstantCalculatorActivityTest {
    ...
    public void clickOnClearButton_shouldClearDisplays() {
        ...
        // SignatureModels display should be empty, calculator display should be zero
